...
function runSQL($rsql) {
	...
	$db['default']['username'] = 'aiki';
	$db['default']['password'] = "Brf;|JQhfh?F";
	$db['default']['database'] = "aiki_aikiframework";
...
$sql = "SELECT id,name,sys_name FROM aiki_language $where $sort $limit";
$result = runSQL($sql);

$total = countRec("id","aiki_language $where");
