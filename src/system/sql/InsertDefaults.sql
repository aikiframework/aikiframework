...
(2, 0, 'added_successfully', 'Added successfully<br />', '', '', ''),
(3, 0, 'error_inserting_into_database', 'Error inserting into database<br />', '', '', ''),
(4, 0, 'next', 'Next >', '', '', ''),
...
(11, 0, 'please_enter_a_password', '<b>Please enter a password</b><br />', '', '', ''),
(12, 0, 'the_email_address_is_not_valid', '<b>The email address is not valid</b><br />', '', '', ''),
(13, 0, 'this_value_is_already_in_use', '<b>This value is already in use</b><br />', '', '', ''),
(14, 0, 'error_while_uploading', 'an error occurred while uploading 0 byte file size, please go back and try again', '', '', ''),
(15, 0, 'not_valid_filename', 'Not valid filename', '', '', ''),
(16, 0, 'file_is_already_uploaded', 'Sorry the same file is already uploaded', '', '', ''),
(17, 0, 'new_directory_created', 'new directory created:', '', '', ''),
(18, 0, 'folder_not_found', 'can not upload file. folder not found', '', '', ''),
(19, 0, 'sorry', 'Sorry', '', '', ''),
...
(23, 0, 'file_already_exists', '<small>(File already exists)</small><br />', '', '', ''),
(24, 0, 'not_allowed_file_name', '<small>(Not allowed file name)</small><br />', '', '', ''),
(25, 0, 'file_upload_fail', '<small>(File upload fail)</small><br />', '', '', ''),
(26, 0, 'uploaded', 'uploaded', '', '', ''),
(27, 0, 'files_out_of', 'files out of', '', '', ''),
(28, 0, 'selected_files', 'selected files<br /><br />', '', '', ''),
(29, 0, 'uploaded_files', '<b>Uploaded files:</b><br />', '', '', ''),
(30, 0, 'not_uploaded_files', '<br /><b>NOT uploaded files:</b><br />', '', '', ''),
(31, 0, 'filename', 'Filename:<br />', '', '', ''),
(32, 0, 'no_primary_key', 'Fatel Error: No primary key, nothing to do', '', '', ''),
(33, 0, 'yes', 'Yes', '', '', ''),
(34, 0, 'no', 'No', '', '', ''),
(35, 0, 'record', 'Record', '', '', ''),
...
(17, 0, '', '', '', 'aiki_users', 'aiki_users', 'a:5:{s:9:"tablename";s:10:"aiki_users";s:4:"pkey";s:6:"userid";s:10:"textinput2";s:27:"username|SystemGOD:username";s:9:"password4";s:44:"password|SystemGOD:password:password:md5|md5";s:10:"textinput6";s:21:"email|SystemGOD:email";}', '', ''),
