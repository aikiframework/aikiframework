					...
					if (!$module_form){
						...
						foreach($viewArray as $field)
						{
							if ($field != $tablename and $field != $pkey){
								...
								if (isset ($get_permission_and_man_info['1']) and $get_permission_and_man_info['1']){
											...
											break;
												...
												case "staticselect":
													...
													if ($intwalker['2'] == "custome" and $intwalker['3']){
														$layout->forms .= '<select name="'.$intwalker[0].'" dir="'; if (isset($get_permission_and_man_info['3'])){$layout->forms .= $get_permission_and_man_info[3];} $layout->forms .= '">';
												...
												case "selection":
													...
													<td><select name="'.$intwalker[0].'" dir="'; if (isset($get_permission_and_man_info['3'])){$layout->forms .= $get_permission_and_man_info[3];} $layout->forms .= '">
												...
												case "textinput":
													...
													$layout->forms .= '<tr><td>'.$intwalker['1'].'</td><td><input type="text" name="'.$intwalker['0'].'" dir="'; if (isset($get_permission_and_man_info['3'])){$layout->forms .= $get_permission_and_man_info['3'];} $layout->forms .='" value="'.$thefild.'"></td></tr>';
													break;
												...
												case "bigtextblock":
													...
													$layout->forms .= '<tr><td>'.$intwalker[1].'</td><td><textarea id="bigfont" dir="'; if (isset($get_permission_and_man_info['3'])){$layout->forms .= $get_permission_and_man_info[3];} $layout->forms .= '" style="height: 500px; width: 600px; display: block;" name="'.$intwalker[0].'">'.$thefild.'</textarea></td></tr>';
													break;
												...
												case "normaltextblock":
													...
													$layout->forms .= '<tr><td>'.$intwalker['1'].'</td><td><textarea rows="7" dir="'; if (isset($get_permission_and_man_info['3'])){$layout->forms .= $get_permission_and_man_info[3];} $layout->forms .= '" cols="50" name="'.$intwalker[0].'">'.$thefild.'</textarea></td></tr>';
													break;
						...
						<input type="hidden" value="'; if (isset($_SERVER['HTTP_REFERER'])){$layout->forms .= $_SERVER['HTTP_REFERER'];} $layout->forms .= '" name="httpreferer">
